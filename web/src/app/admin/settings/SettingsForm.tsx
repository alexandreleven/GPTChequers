  ...
  return (
    <>
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use Chequers Capital."
          ...
          <Modal.Content>
            ...
            <Modal.Body>
              <p>
                ...
                anyone to use Chequers Capital without signing in.
              </p>
            </Modal.Body>
            <Modal.Footer>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Chequers Capital to retain chat messages. Leaving this field empty will cause Chequers Capital to never delete chat messages."
