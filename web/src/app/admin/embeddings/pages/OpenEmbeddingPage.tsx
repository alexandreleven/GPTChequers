  ...
  return (
    <div>
      ...
      <Text className="mt-6">
        ...
        .
        <br />
        <b>NOTE:</b> not all models listed will work with Chequers Capital,
        since some have unique interfaces or special requirements. If in doubt,
        reach out to the Chequers Capital team.
      </Text>
      {!configureModel && (
        <Button
