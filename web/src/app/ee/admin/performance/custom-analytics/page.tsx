...
function Main() {
      ...
      <div>
        <div className="mt-4">
          <Callout type="danger" title="Custom Analytics is not enabled.">
            ...
            setup Chequers Capital in your team to set the{" "}
  ...
  return (
    <div>
      <Text className="mb-8">
        This allows you to bring your own analytics tool to Chequers Capital!
        Copy the Web snippet from your analytics provider into the box below,
        and we&apos;ll start sending usage events.
      </Text>
